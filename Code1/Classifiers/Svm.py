...
def svmlinear(X_train, y_train, X_test, y_test, images, testIm):
    ...
    Code1.Draw.drawPredict(svclassifier1, X_test, y_test, images, testIm)
    return acc
...
def svmpoly(X_train, y_train, X_test, y_test, images, testIm):
    ...
    Code1.Draw.drawPredict(svclassifier2, X_test, y_test, images, testIm)
    return acc
...
def svmrbf(X_train, y_train, X_test, y_test, images, testIm):
    ...
    Code1.Draw.drawPredict(svclassifier3, X_test, y_test, images, testIm)
    return acc
...
def svmsigmoid(X_train, y_train, X_test, y_test, images, testIm):
    ...
    Code1.Draw.drawPredict(svclassifier4, X_test, y_test, images, testIm)
    return acc
